...
Codex-focused video editing skills for premium short-form content.
...
`codex-video-editor` turns Codex into a disciplined short-form editor for business, AI, SaaS, podcast, educational, and creator clips.
...
- bottom 50% talking head
- captions in the center separator area
- one meaningful visual change every 3-4 seconds
- 2-3 brand colors only unless the user asks otherwise
